    ...
    <section className="flex flex-col m-auto mt-20 md:m-20 md:mb-30 bg-white">
      <div className="container mx-auto">
        <div className=" flex flex-col m-auto text-center w-7/12">
          ...
          <p className="text-xs font-raleway mt-2 mb-20 text-dark-gray">
        ...
        <div className="flex flex-col justify-center items-center lg:flex-row lg:justify-between lg:ml-6 lg:mr-6">
          <Steps variant="wattering" />
          <Steps variant="sunlight" />
          <Steps variant="NutrientsandFertilizing" />
        </div>

        <div className="flex flex-col gap-6 lg:flex-row w-full justify-between">
          <div className="w-72 flex m-auto mt-16 lg:mt-52 md:w-96">
            <img
              src={img1}
              alt="Imagem de um ambiente interno com muitas folhagens"
            />
          </div>
          ...
          <div className="w-72 flex m-auto mt-16 lg:mt-52 md:w-96">
            <img
              src={img2}
              alt="Imagem de um ambiente externo com muitas folhagens"
            />
          </div>

          <div className="w-72 flex flex-col m-auto mt-16 lg:mt-52 md:w-96">
